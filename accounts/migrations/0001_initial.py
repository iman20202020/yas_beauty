# Generated by Django 3.2.5 on 2021-10-18 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_image', models.ImageField(help_text='عکس مدرک تحصیلی خود را بارگذاری کنید', upload_to='images/', validators=[accounts.validators.validate_image_size])),
                ('qualification', models.CharField(blank=True, help_text='مدرک تحصیلی و گرایش تحصیلی خود را ذکر کنید', max_length=256)),
